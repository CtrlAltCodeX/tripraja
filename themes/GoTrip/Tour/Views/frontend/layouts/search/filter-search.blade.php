            ...
            <div class="sidebar-checkbox">
                ...
                ?>
                        <div class="row y-gap-10 items-center justify-between">
                            <div class="col-auto">
                                <label class="d-flex">
                                    <input name="cat_id[]" {{$checked}} type="checkbox" value="{{$category->id}}"> {{$prefix}} {{$translate->name}} </label>
                            </div>
            ...
            <div class="row x-gap-10 y-gap-30">
                <div class="col-12">
                    <div class="js-price-searchPage">
                        ...
                        ?>
                        <input type="hidden" class="filter-price irs-hidden-input" name="price_range" data-symbol=" {{$currency['symbol'] ?? ''}}" data-min="{{$price_min}}" data-max="{{$price_max}}" data-from="{{$pri_from}}" data-to="{{$pri_to}}" readonly="" value="{{$price_range}}">
